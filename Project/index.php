<?php 
    ...
    $projects = $system->GetAllProjectsByDepartmentid($department_id);    
?>
<!DOCTYPE html>
<html>
<head>
...
<form class="form-inline definewidth m20" action="index.php" method="get">    
    ...
    <button type="submit" class="btn btn-primary">查询</button>&nbsp;&nbsp; <button type="button" class="btn btn-success" id="addnew">新增项目</button>
</form>
...
<?php
	 if(!empty($projects))
     {
        ...
        foreach ($projects as $key => $project) {
            ...
            //echo "xiaoshu=".floatval(floatval($v)/floatval(100));
            $chart_len = 100;
            $chart_hight = 20;
            $chart_border=0;
