<?php 
    ...
    $dt = isset($_GET['md_date'])?$_GET['md_date']:date("Y-m-d",time());
    $staffid = $staff_id;
?>
<!DOCTYPE html>
<html>
...
<table class="table table-bordered table-hover definewidth m10">
    ...
    $now = $dt;
             echo "<thead>
                ...
                <th style='align:center'><a href='chakan.php'><button>返回</button></a></th>
                </tr>
            </thead>";
            $work_daym = 1; 
            ...
            <form id='formid_$now' method='post' action='editrido.php?date=$now'>
