 ...
 <body>
  ...
  <script>
    BUI.use('common/main',function(){
      ...
      items:[{id:'12',text:'部门管理',href:'Node/index.php'},
      {id:'3',text:'人员管理',href:'Role/index.php'},
      {id:'4',text:'项目管理',href:'Project/index.php'},
      {id:'6',text:'填写日报',href:'Menu/index.php'},
      {id:'19',text:'部门日报',href:'DR/index.php'},
      {id:'20',text:'日报查询',href:'DR/chakan.php'},
      {id:'9',text:'个人中心',href:'Role/center.php'}]}]},{id:'7',homePage : '9',menu:[{text:'业务管理',items:[{id:'9',text:'查询业务',href:'Node/index.html'}]}]}];
